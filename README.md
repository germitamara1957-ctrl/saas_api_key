...
بوابة AI وسيطة (SaaS) مبنية كـ pnpm monorepo بـ TypeScript — تُوكِّل طلبات المطورين إلى **Google Vertex AI** (Gemini 2.5 / 3.x / Imagen / Veo) وشركاء (Grok, DeepSeek, Kimi, MiniMax, Gemma) عبر مفتاح API واحد، مع فوترة تلقائية بمعامل **1.1×** على أسعار Vertex AI الرسمية.

> **23 نموذج حي** + 19 نموذج قادم (Coming Soon)
...
| الميزة | التفاصيل |
|--------|---------|
| **وكيل API موحَّد** | `/v1/chat/completions` · `/v1/images/generations` · `/v1/videos/generations` · SSE Streaming |
| **23 نموذج حي** | Gemini 2.5 + 3.x + Imagen + Veo + Grok + DeepSeek + Kimi + MiniMax + Gemma |
...
| الجدول | الغرض |
|--------|-------|
| `users` | مصادقة · أدوار · رصيد · تحقق البريد |
